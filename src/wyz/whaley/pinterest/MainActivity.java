...
import wyz.whaley.pinterest.http.JSONRequest;
...
public class MainActivity extends Activity {
    ...
    private void initPreference() {
        SharedPreferences sharedPreferences = getSharedPreferences(PreferenceUtility.PREFERRENCE_SETTING, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        mIsOpenFirst = sharedPreferences.getBoolean(PreferenceUtility.FIRST_OPEN, true);
        if (mIsOpenFirst) {
            editor.putBoolean(PreferenceUtility.FIRST_OPEN, false).commit();
        }
        mItemCount = sharedPreferences.getInt(PreferenceUtility.ITEM_SUM, 0);
    ...
    private void requestData(int page) {
        ...
        Request request = new JSONRequest(url, new ResponseListener() {
    ...
    private class MyAdapter implements MyBaseAdapter, DBChangeListener {
        ...
        public View getView(View v, int position) {
            ...
            if (v == null) {
                ...
                viewHolder.imageView = (ImageView) v.findViewById(R.id.item_iv);
                v.setTag(viewHolder);
            ...
            if (!url.equals("")) {
                ...
                ImageLoader.getInstance().displayImage(MainActivity.this, viewHolder.imageView, url, position, isFling);
            }
            return v;
        }
